...
export default async function HomePage() {
  ...
  const jsonLd = {
    ...
    "@type": "WebSite",
    name: "Soft Key",
    url: process.env.NEXT_PUBLIC_SITE_URL ?? "https://soft-key.vercel.app",
    potentialAction: {
      "@type": "SearchAction",
      target: `${process.env.NEXT_PUBLIC_SITE_URL ?? "https://soft-key.vercel.app"}/products?q={search_term_string}`,
